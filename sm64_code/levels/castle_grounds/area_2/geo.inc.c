const GeoLayout castle_grounds_area_2_Level[] = {
    ...
    GEO_OPEN_NODE(),
        ...
        GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(1, 0, 0, 0, NULL),
            GEO_OPEN_NODE(),
                GEO_ANIMATED_PART(1, 0, 0, 700, castle_grounds_Traverse_mesh),
                GEO_ANIMATED_PART(1, -682, -450, 700, castle_grounds_Open_mesh),
                GEO_ANIMATED_PART(1, 682, 450, 700, castle_grounds_Close_mesh),
            GEO_CLOSE_NODE(),
        GEO_CLOSE_NODE(),
    GEO_CLOSE_NODE(),
    GEO_RETURN(),
