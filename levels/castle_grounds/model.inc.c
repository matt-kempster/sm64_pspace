...
static const Vtx castle_grounds_Plane_mesh_vtx[] = {
...
const Gfx castle_grounds_Plane_mesh_tri_0[] = {
	gsSPVertex(castle_grounds_Plane_mesh_vtx + 0, 4, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSPEndDisplayList(),
};

const Gfx castle_grounds_Plane_mesh[] = {
	gsSPDisplayList(mat_castle_grounds_sm64_material),
	gsSPDisplayList(castle_grounds_Plane_mesh_tri_0),
	gsDPPipeSync(),
